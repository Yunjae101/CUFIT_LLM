...
def train():
    ...
    for epoch in range(max_epoch):
        ...
        for batch_idx, (inputs, targets) in enumerate(train_loader):
            ...
            print('\r', batch_idx, len(train_loader), 'Loss: %.3f | Acc2: %.3f%% | Acc1: %.3f%% |  (%d/%d)'
                        % (total_loss/(batch_idx+1), 100.*correct2/total, 100.*correct/total, correct, total), end = '')                     
        ...
        print('EPOCH {:4}, TRAIN [loss - {:.4f}, acc - {:.4f}], VALID_2 [acc - {:.4f}], VALID_1 [acc - {:.4f}] \n'.format(epoch, train_avg_loss, train_accuracy, valid_accuracy, valid_accuracy_))
